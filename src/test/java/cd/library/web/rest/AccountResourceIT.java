...
import static cd.library.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import cd.library.IntegrationTest;
import cd.library.config.Constants;
import cd.library.domain.User;
import cd.library.repository.AuthorityRepository;
import cd.library.repository.UserRepository;
import cd.library.security.AuthoritiesConstants;
import cd.library.service.UserService;
import cd.library.service.dto.AdminUserDTO;
import cd.library.service.dto.PasswordChangeDTO;
import cd.library.service.dto.UserDTO;
import cd.library.web.rest.vm.KeyAndPasswordVM;
import cd.library.web.rest.vm.ManagedUserVM;
