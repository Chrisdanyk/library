    ...
    instance.events['keyboard'] = addEvent('keydown', {
      ...
      withCallback: function withCallback(event, target) {
        ...
        if (key == 9) {
          ...
          if (!focusedButton) {
            var activeElement =
              document.activeElement && document.activeElement.nodeName ? document.activeElement.nodeName.toLocaleLowerCase() : false;
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectAssets(this.settings.plyr.js, 'Plyr', function () {
      ...
      var placeholder = customPlaceholder
        ? customPlaceholder
        : createHTML(
            '<div id="'.concat(videoID, '" data-plyr-provider="').concat(videoSource, '" data-plyr-embed-id="').concat(embedID, '"></div>')
          );
    ...
    _createClass(GlightboxInit, [
      ...
      },
      {
        ...
        value: function resize() {
          ...
          if (
            description &&
            (hasClass(description, 'description-bottom') || hasClass(description, 'description-top')) &&
