      ...
      var s = function (i) {
        for (var n in i)
          Object.prototype.hasOwnProperty.call(i, n) &&
            (t && '[object Object]' === Object.prototype.toString.call(i[n]) ? (e[n] = l(!0, e[n], i[n])) : (e[n] = i[n]));
      };
      i < n;
      i++
    ) {
          ...
          value: function (e) {
            if (e.touches) {
              ...
              if (((this.isDoubleTap = !1), i > 1)) {
                ...
                null !== t.x &&
                  (this.pinchStartLen > 0 && ((e.zoom = Y(r) / this.pinchStartLen), this.pinch.dispatch(e, this.element)),
                  (e.angle = q(r, t)),
                ...
                -1 !== ['input', 'select', 'textarea', 'button', 'a'].indexOf(t)
                  ...
                  : (e.preventDefault(),
                    (e.target === this.el || ('img' !== t && u(e.target, '.gslide-inline'))) &&
                      ((this.active = !0), this.el.classList.add('dragging'), (this.dragContainer = u(e.target, '.ginner-container'))));
              }
            },
          },
          {
