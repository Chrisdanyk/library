...
!(function (t, e) {
  ...
  class pt extends B {
    ...
    _getConfig(t) {
      return (
        ((t = { ...rt, ...U.getDataAttributes(this._element), ...t }).toggle = Boolean(t.toggle)), (t.parent = r(t.parent)), a(ot, t, at), t
      );
    }
    _getDimension() {
  ...
  function de(t) {
    ...
    return l
      ? Object.assign(
          ...
          (T[b] = g ? '0' : ''),
          (T.transform =
            (y.devicePixelRatio || 1) <= 1 ? 'translate(' + f + 'px, ' + m + 'px)' : 'translate3d(' + f + 'px, ' + m + 'px, 0)'),
          T)
        )
      ...
      : Te(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              'rtl' === Yt(s || i).direction && (a += ie(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
            );
          })(Gt(t))
        );
  }
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [g].concat(b).reduce(function (t, i) {
              return t.concat(
                Ut(i) === vt
                  ? Le(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m })
                  : i
              );
            }, []),
            y = e.rects.reference,
  ...
  function Me(t, e, i) {
    ...
    return (
      (n || (!n && !i)) &&
        (('body' !== Rt(e) || we(r)) &&
          (l = (s = e) !== Wt(s) && zt(s) ? { scrollLeft: (o = s).scrollLeft, scrollTop: o.scrollTop } : ve(s)),
    ...
    static dataApiKeydownHandler(t) {
      if (
        /input|textarea/i.test(t.target.tagName)
          ? t.key === Ke || (t.key !== Ve && ((t.key !== Ye && t.key !== Xe) || t.target.closest(ei)))
          : !Qe.test(t.key)
      )
        return;
  ...
  class un extends B {
    ...
    show() {
      ...
      H.set(n, this.constructor.DATA_KEY, this),
        this._element.ownerDocument.documentElement.contains(this.tip) ||
          (a.append(n), j.trigger(this._element, this.constructor.Event.INSERTED)),
    ...
    setElementContent(t, e) {
      if (null !== t)
        return o(e)
          ? ((e = r(e)),
            void (this._config.html ? e.parentNode !== t && ((t.innerHTML = ''), t.append(e)) : (t.textContent = e.textContent)))
  ...
  class An extends B {
    ...
    _getConfig(t) {
      return (
        ((t = { ...bn, ...U.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) }).target =
          r(t.target) || document.documentElement),
        a(_n, t, vn),
        t
      );
    }
  ...
  class Mn extends B {
    ...
    _getConfig(t) {
      return (
        (t = { ...jn, ...U.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) }),
