...
const EventHandler = {
    ...
    trigger(e, t, i) {
      ...
      return (
        ...
        r ? ((_ = document.createEvent('HTMLEvents')), _.initEvent(s, l, !0)) : (_ = new CustomEvent(t, { bubbles: l, cancelable: !0 })),
        void 0 !== i &&
...
const Manipulator = {
  ...
  SWIPE_THRESHOLD = 40,
  Default$a = { interval: 5e3, keyboard: !0, slide: !1, pause: 'hover', wrap: !0, touch: !0 },
  DefaultType$a = {
...
class Carousel extends BaseComponent {
  ...
  pause(e) {
    e || (this._isPaused = !0),
      SelectorEngine.findOne(SELECTOR_NEXT_PREV, this._element) && (triggerTransitionEnd(this._element), this.cycle(!0)),
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$a, ...Manipulator.getDataAttributes(this._element), ...('object' == typeof e ? e : {}) }),
  ...
  _addEventListeners() {
    this._config.keyboard && EventHandler.on(this._element, EVENT_KEYDOWN, e => this._keydown(e)),
  ...
  static dataApiClickHandler(e) {
    ...
    const i = { ...Manipulator.getDataAttributes(t), ...Manipulator.getDataAttributes(this) },
...
class Collapse extends BaseComponent {
  ...
  show() {
    ...
    if (this._config.parent) {
      ...
      t = SelectorEngine.find(SELECTOR_ACTIVES, this._config.parent).filter(t => !e.includes(t));
    }
    ...
    t.forEach(t => {
      i !== t && Collapse.getOrCreateInstance(t, { toggle: !1 }).hide(), e || Data.set(t, DATA_KEY$9, null);
    });
  ...
  _getConfig(e) {
    return (
      ((e = { ...Default$9, ...Manipulator.getDataAttributes(this._element), ...e }).toggle = Boolean(e.toggle)),
...
const NAME$9 = 'dropdown',
  ...
  Default$8 = { offset: [0, 2], boundary: 'clippingParents', reference: 'toggle', display: 'dynamic', popperConfig: null, autoClose: !0 },
  DefaultType$8 = {
...
class Dropdown extends BaseComponent {
  ...
  show() {
    ...
    this._inNavbar ? Manipulator.setDataAttribute(this._menu, 'popper', 'none') : this._createPopper(t),
      'ontouchstart' in document.documentElement &&
        !t.closest('.navbar-nav') &&
        [].concat(...document.body.children).forEach(e => EventHandler.on(e, 'mouseover', noop)),
      this._element.focus(),
  ...
  _completeHide(e) {
    EventHandler.trigger(this._element, EVENT_HIDE$4, e).defaultPrevented ||
      ('ontouchstart' in document.documentElement &&
        [].concat(...document.body.children).forEach(e => EventHandler.off(e, 'mouseover', noop)),
  ...
  _getConfig(e) {
    if (
      ((e = { ...this.constructor.Default, ...Manipulator.getDataAttributes(this._element), ...e }),
      typeCheckConfig(NAME$9, e, this.constructor.DefaultType),
      'object' == typeof e.reference && !isElement(e.reference) && 'function' != typeof e.reference.getBoundingClientRect)
    )
      throw new TypeError(
  ...
  static dataApiKeydownHandler(e) {
    if (
      /input|textarea/i.test(e.target.tagName)
        ? 'Space' === e.key || ('Escape' !== e.key && (('ArrowDown' !== e.key && 'ArrowUp' !== e.key) || e.target.closest(SELECTOR_MENU)))
    ...
    const i = this.matches(SELECTOR_DATA_TOGGLE$3) ? this : SelectorEngine.prev(this, SELECTOR_DATA_TOGGLE$3)[0],
...
class ScrollBarHelper {
  ...
  hide() {
    ...
    this._disableOverFlow(),
      ...
      this._setElementAttributes(SELECTOR_FIXED_CONTENT, 'paddingRight', t => t + e),
...
class Backdrop {
  ...
  _getConfig(e) {
    return (
      ((e = { ...Default$7, ...('object' == typeof e ? e : {}) }).rootElement = getElement(e.rootElement)),
...
class FocusTrap {
  ...
  _getConfig(e) {
    return (e = { ...Default$6, ...('object' == typeof e ? e : {}) }), typeCheckConfig(NAME$7, e, DefaultType$6), e;
  }
}
const NAME$6 = 'modal',
  DATA_KEY$6 = 'bs.modal',
...
class Modal extends BaseComponent {
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$5, ...Manipulator.getDataAttributes(this._element), ...('object' == typeof e ? e : {}) }),
  ...
  _adjustDialog() {
    const e = this._element.scrollHeight > document.documentElement.clientHeight,
      ...
      i = t > 0;
    ((!i && e && !isRTL()) || (i && !e && isRTL())) && (this._element.style.paddingLeft = `${t}px`),
      ((i && !e && !isRTL()) || (!i && e && isRTL())) && (this._element.style.paddingRight = `${t}px`);
  }
  _resetAdjustments() {
...
class Offcanvas extends BaseComponent {
  ...
  show(e) {
    this._isShown ||
      EventHandler.trigger(this._element, EVENT_SHOW$2, { relatedTarget: e }).defaultPrevented ||
      ((this._isShown = !0),
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$4, ...Manipulator.getDataAttributes(this._element), ...('object' == typeof e ? e : {}) }),
...
EventHandler.on(document, EVENT_CLICK_DATA_API$1, SELECTOR_DATA_TOGGLE$1, function (e) {
  ...
  EventHandler.on(window, EVENT_LOAD_DATA_API$1, () =>
    SelectorEngine.find(OPEN_SELECTOR).forEach(e => Offcanvas.getOrCreateInstance(e).show())
  ),
...
class Tooltip extends BaseComponent {
  ...
  show() {
    ...
    Data.set(n, this.constructor.DATA_KEY, this),
      this._element.ownerDocument.documentElement.contains(this.tip) ||
        (a.append(n), EventHandler.trigger(this._element, this.constructor.Event.INSERTED)),
      this._popper ? this._popper.update() : (this._popper = Popper.createPopper(this._element, n, this._getPopperConfig(r))),
  ...
  setElementContent(e, t) {
    if (null !== e)
      return isElement(t)
        ? ((t = getElement(t)),
          void (this._config.html ? t.parentNode !== e && ((e.innerHTML = ''), e.append(t)) : (e.textContent = t.textContent)))
        : void (this._config.html
            ? (this._config.sanitize && (t = sanitizeHtml(t, this._config.allowList, this._config.sanitizeFn)), (e.innerHTML = t))
            : (e.textContent = t));
  }
  getTitle() {
  ...
  _setListeners() {
    this._config.trigger.split(' ').forEach(e => {
      if ('click' === e) EventHandler.on(this._element, this.constructor.Event.CLICK, this._config.selector, e => this.toggle(e));
      else if ('manual' !== e) {
        ...
        EventHandler.on(this._element, t, this._config.selector, e => this._enter(e)),
          EventHandler.on(this._element, i, this._config.selector, e => this._leave(e));
      }
    }),
  ...
  _getConfig(e) {
    ...
    return (
      ...
      ((e = { ...this.constructor.Default, ...t, ...('object' == typeof e && e ? e : {}) }).container =
      ...
      e.sanitize && (e.template = sanitizeHtml(e.template, e.allowList, e.sanitizeFn)),
      e
    );
  }
  _getDelegateConfig() {
...
const NAME$3 = 'popover',
  ...
  DefaultType$2 = { ...Tooltip.DefaultType, content: '(string|element|function)' },
  Event$1 = {
...
class ScrollSpy extends BaseComponent {
  ...
  _getConfig(e) {
    return (
      ((e = { ...Default$1, ...Manipulator.getDataAttributes(this._element), ...('object' == typeof e && e ? e : {}) }).target =
        getElement(e.target) || document.documentElement),
  ...
  _activate(e) {
    ...
    i.classList.add('active'),
      i.classList.contains('dropdown-item')
        ? SelectorEngine.findOne('.dropdown-toggle', i.closest('.dropdown')).classList.add('active')
        : SelectorEngine.parents(i, '.nav, .list-group').forEach(e => {
            SelectorEngine.prev(e, '.nav-link, .list-group-item').forEach(e => e.classList.add('active')),
              SelectorEngine.prev(e, '.nav-item').forEach(e => {
                SelectorEngine.children(e, '.nav-link').forEach(e => e.classList.add('active'));
              });
          }),
...
class Tab extends BaseComponent {
  ...
  show() {
    ...
    if (EventHandler.trigger(this._element, EVENT_SHOW$1, { relatedTarget: e }).defaultPrevented || (null !== n && n.defaultPrevented))
      return;
    this._activate(this._element, i);
    const s = () => {
      EventHandler.trigger(e, EVENT_HIDDEN$1, { relatedTarget: this._element }),
        EventHandler.trigger(this._element, EVENT_SHOWN$1, { relatedTarget: e });
    };
  ...
  _transitionComplete(e, t, i) {
    if (t) {
      ...
      const e = SelectorEngine.findOne(SELECTOR_DROPDOWN_ACTIVE_CHILD, t.parentNode);
    ...
    if ((n && 'LI' === n.nodeName && (n = n.parentNode), n && n.classList.contains('dropdown-menu'))) {
      ...
      t && SelectorEngine.find('.dropdown-toggle', t).forEach(e => e.classList.add('active')), e.setAttribute('aria-expanded', !0);
    }
    i && i();
  }
  static jQueryInterface(e) {
...
class Toast extends BaseComponent {
  ...
  _getConfig(e) {
    return (
      (e = { ...Default, ...Manipulator.getDataAttributes(this._element), ...('object' == typeof e && e ? e : {}) }),
