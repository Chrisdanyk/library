...
!(function (t, e) {
  ...
  class at extends R {
    ...
    pause(t) {
      t || (this._isPaused = !0),
        Y.findOne('.carousel-item-next, .carousel-item-prev', this._element) && (a(this._element), this.cycle(!0)),
  ...
  class mt extends R {
    ...
    _getConfig(t) {
      return (
        ((t = { ...ct, ...X.getDataAttributes(this._element), ...t }).toggle = Boolean(t.toggle)), (t.parent = c(t.parent)), h(lt, t, ht), t
      );
    }
    _getDimension() {
    ...
    static dataApiKeydownHandler(t) {
      if (
        /input|textarea/i.test(t.target.tagName)
          ? t.key === yt || (t.key !== vt && ((t.key !== wt && t.key !== Et) || t.target.closest(St)))
          : !At.test(t.key)
      )
        return;
      ...
      if (t.key !== vt)
        return t.key === Et || t.key === wt ? (e || s.show(), void s._selectMenuItem(t)) : void ((e && t.key !== yt) || Ht.clearMenus());
      s.hide();
    }
  }
      ...
      if (null !== t)
        return l(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize && (e = we(e, this._config.allowList, this._config.sanitizeFn)), (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
  ...
  class Ye extends R {
    ...
    _getConfig(t) {
      return (
        ((t = { ...We, ...X.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) }).target =
          c(t.target) || document.documentElement),
        h(qe, t, Ue),
        t
      );
    }
  ...
  class li extends R {
    ...
    _getConfig(t) {
      return (
        (t = { ...ai, ...X.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) }),
