...
!(function (e, t) {
  ...
  function P(e) {
    ...
    let o = e;
    if (
      (o.originalEvent && (o = o.originalEvent), s.allowTouchCallbacks && t.emit('touchEnd', o), (s.allowTouchCallbacks = !1), !s.isTouched)
    )
    ...
    if (
      (t.allowClick &&
        (t.updateClickedSlide(o), t.emit('tap click', o), c < 300 && d - s.lastClickTime < 300 && t.emit('doubleTap doubleClick', o)),
      (s.lastClickTime = u()),
      p(() => {
      ...
      update: {
        ...
        updateSlides: function () {
          ...
          'string' == typeof x && x.indexOf('%') >= 0 && (x = (parseFloat(x.replace('%', '')) / 100) * r),
            ...
            a.centeredSlides &&
              a.cssMode &&
              (g(e.wrapperEl, '--swiper-centered-offset-before', ''), g(e.wrapperEl, '--swiper-centered-offset-after', ''));
        ...
        updateSlidesProgress: function (e = (this && this.translate) || 0) {
          ...
          for (let e = 0; e < a.length; e += 1) {
            ...
            ((d >= 0 && d < t.size - 1) || (c > 1 && c <= t.size) || (d <= 0 && c >= t.size)) &&
              (t.visibleSlides.push(n), t.visibleSlidesIndexes.push(e), a.eq(e).addClass(s.slideVisibleClass)),
              (n.progress = i ? -o : o);
          }
  ...
  const J = [
        ...
        Object.assign(e.virtual, {
          ...
          removeSlide: function (t) {
            ...
            if (Array.isArray(t))
              ...
              e.virtual.slides.splice(t, 1), e.params.virtual.cache && delete e.virtual.cache[t], t < s && (s -= 1), (s = Math.max(s, 0));
            r(!0), e.slideTo(s, 0);
          },
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function c() {
          ...
          if (
            (s.dynamicBullets &&
              ...
              s.dynamicMainBullets > 1 &&
                ...
                ((n += p - e.previousIndex), n > s.dynamicMainBullets - 1 ? (n = s.dynamicMainBullets - 1) : n < 0 && (n = 0)),
              (i = p - n),
            ...
            a.each(e => {
              ...
              a === p && t.addClass(s.bulletActiveClass),
                s.dynamicBullets &&
                  (a >= i && a <= l && t.addClass(`${s.bulletActiveClass}-main`), a === i && o(t, 'prev'), a === l && o(t, 'next'));
            });
          else {
            const t = a.eq(p),
              r = t.index();
        ...
        if (
          ('fraction' === s.type &&
            (c.find(W(s.currentClass)).text(s.formatFractionCurrent(p + 1)), c.find(W(s.totalClass)).text(s.formatFractionTotal(u))),
          'progressbar' === s.type)
        ) {
          let t;
                ...
                e.pagination.bullets.each(s => {
                  ...
                  r(a),
                    e.params.pagination.renderBullet ||
                      (l(a, 'button'), c(a, t.paginationBulletMessage.replace(/\{\{index\}\}/, a.index() + 1)));
                });
            })();
        }),
        s('destroy', () => {
          ...
          (() => {
            ...
            if (e.params.history) {
              ...
              (a = !0),
                (i = l(e.params.url)),
                (i.key || i.value) &&
                  (d(0, i.value, e.params.runCallbacksOnInit), e.params.history.replaceState || t.addEventListener('popstate', c));
            }
          })();
      }),
        s('destroy', () => {
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function o() {
        return (
          !!e.autoplay.running && void 0 !== r && (r && (clearTimeout(r), (r = void 0)), (e.autoplay.running = !1), i('autoplayStop'), !0)
        );
      }
      function d(t) {
        e.autoplay.running &&
                ...
                if (i.freeMode.momentum) {
                  ...
                  if (c < e.maxTranslate())
                    i.freeMode.momentumBounce
                      ? (c + e.maxTranslate() < -m && (c = e.maxTranslate() - m),
                        (p = e.maxTranslate()),
                        (h = !0),
                  ...
                  if (
                    ...
                    if (
                      ((t = n ? Math.abs((-c - e.translate) / e.velocity) : Math.abs((c - e.translate) / e.velocity)), i.freeMode.sticky)
                    ) {
        ...
        F({
          ...
          setTranslate: () => {
            ...
            for (let l = 0; l < t.length; l += 1) {
              ...
              if (
                ((u = c < 0 ? `calc(${u}px + (${v * Math.abs(c)}%))` : c > 0 ? `calc(${u}px + (-${v * Math.abs(c)}%))` : `${u}px`),
                !e.isHorizontal())
              ) {
                const e = h;
                (h = u), (u = e);
